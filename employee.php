...
<head>
    ...
    <title>National Park | Admin Portal | Employee</title>
        ...
        <div class="content" style="padding: 10px 50px;">
            ...
            <div class="container">
                <?php
                    ...
                    $q = "SELECT * FROM employee WHERE f_name LIKE '%$s%' OR l_name LIKE '%$s%'";
                    ...
                    if ($res==TRUE) {
                        ...
                        if ($count>0) {
                            ...
                            while ($rows=mysqli_fetch_assoc($res)) {
                                ...
                                $pos = $rows['position'];
                                $email = $rows['email'];
                                $q2 = "SELECT phone from emp_contact where e_id=$id";
                                ?>
                                <div class="record">
                                    <h3><?php echo $name ?></h3>
